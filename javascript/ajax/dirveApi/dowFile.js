...
module.exports = function (id) {
    ...
    /*function downloadFile(auth) {
        ...
        var fileId = '16jom6jLWbk5Cej8GKzrFg8LsShZnZnuM6Ua9SlzA0ug';
        var dest = fs.createWriteStream('/Users/Manu/Downloads/temp.pdf');
        drive.files.export({
            fileId: fileId,
    ...
    /*function downloadFile(auth) {
        const drive = google.drive({ version: "v3", auth });
        const filePath = `/Users/Manu/Downloads/temp.pdf`;
      ...
      function downloadFile(auth) {
        const drive = google.drive({ version: "v3", auth });
    var fileId = '1N1PPMOm3SN-tnkjWCY5gVFQPX1hnXdD6';
    var dest = fs.createWriteStream(`/Users/Manu/Downloads/temp.pdf`);
    drive.files.get({
        fileId: fileId,
        alt: 'media'
